...
public class Pengaduan_pengadu extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Pengaduan_pengadu.class.getName());

    public Pengaduan_pengadu() {
        setUndecorated(true);
        initComponents();
        this.pack();
    ...
    private void initComponents() {
        ...
        jButton4.setText("Tambah Pengaduan");
        ...
        jButton3.setText("Lihat Tabel Tanggapan");
        ...
        jLabel4.setText("Di halaman ini, Anda dapat mengajukan pengaduan baru, melihat daftar laporan Anda, serta");

        jLabel5.setFont(new java.awt.Font("Candara", 0, 12)); // NOI18N
        jLabel5.setText("memantau tanggapan dari pihak instansi terkait. Pastikan setiap laporan berisi informasi");

        jLabel6.setFont(new java.awt.Font("Candara", 0, 12)); // NOI18N
        jLabel6.setText("yang jelas, sopan, dan disertai bukti yang relevan agar dapat ditindaklanjuti dengan cepat.");
        ...
        jLabel8.setText("Layanan Pengaduan Publik");
        ...
        jLabel9.setText("Melalui sistem ini, Anda dapat berpartisipasi secara langsung dalam meningkatkan kualitas");

        jLabel10.setFont(new java.awt.Font("Candara", 0, 12)); // NOI18N
        jLabel10.setText("pelayanan publik dan transparansi instansi pemerintah. Sistem ini bertujuan untuk mewujudkan");

        jLabel11.setFont(new java.awt.Font("Candara", 0, 12)); // NOI18N
        jLabel11.setText("pemerintahan yang terbuka, akuntabel, dan responsif terhadap kebutuhan masyarakat.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Pengaduan_pengadu().setVisible(true));
    }
