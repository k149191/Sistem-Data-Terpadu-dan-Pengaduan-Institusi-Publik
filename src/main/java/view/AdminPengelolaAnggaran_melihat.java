...
public class AdminPengelolaAnggaran_melihat extends javax.swing.JFrame {
private final DecimalFormat rupiah;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdminPengelolaAnggaran_melihat.class.getName());

    public AdminPengelolaAnggaran_melihat() {
    DecimalFormatSymbols symbols = new DecimalFormatSymbols(new Locale("id", "ID"));
    symbols.setCurrencySymbol("Rp");
    symbols.setGroupingSeparator('.');
    symbols.setMonetaryDecimalSeparator(',');
    rupiah = (DecimalFormat) DecimalFormat.getCurrencyInstance();
    rupiah.setDecimalFormatSymbols(symbols);
    ...
    try (Connection conn = database.DatabaseConnection.getConnection();
        ...
        while (rs.next()) {
        double totalAnggaran = rs.getDouble("total_anggaran");
        double realisasi = rs.getDouble("realisasi");
        String totalAnggaranFormatted = rupiah.format(totalAnggaran);
        String realisasiFormatted = rupiah.format(realisasi);
            Object[] row = new Object[] {
                rs.getString("nama_instansi"),
                rs.getString("tahun"),
                rs.getString("nama_program"),
                totalAnggaranFormatted,   // ubah ini
                realisasiFormatted,
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 361, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AdminPengelolaAnggaran_melihat().setVisible(true));
    }
