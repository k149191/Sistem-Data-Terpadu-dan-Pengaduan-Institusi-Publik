...
public class AdminPengelolaPengaduan extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdminPengelolaPengaduan.class.getName());

    public AdminPengelolaPengaduan() {
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Di sini, Anda dapat meninjau, menanggapi, dan memperbarui status setiap laporan masyarakat. ");

        jLabel7.setFont(new java.awt.Font("Candara", 0, 12)); // NOI18N
        jLabel7.setText("Gunakan halaman ini dengan bijak untuk menjaga kepercayaan publik dan memastikan setiap");

        jLabel8.setFont(new java.awt.Font("Candara", 0, 12)); // NOI18N
        jLabel8.setText("pengaduan ditindaklanjuti dengan transparan.");
        ...
        jLabel4.setText("Anda berada di halaman Manajemen Pengaduan Masyarakat.");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/oranglagi.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AdminPengelolaPengaduan().setVisible(true));
    }
