...
public class AdminPengelolaAnggaran_memperbarui extends javax.swing.JFrame {
    ...
    private void installMoneyInputGuards() {
        ...
        jTextField4.addFocusListener(new java.awt.event.FocusAdapter() {
            @Override public void focusLost(java.awt.event.FocusEvent e) { formatMoneyField(jTextField4); }
        });
        jTextField5.addFocusListener(new java.awt.event.FocusAdapter() {
            @Override public void focusLost(java.awt.event.FocusEvent e) { formatMoneyField(jTextField5); }
        });
    }
    ...
    private String formatIDR(BigDecimal v) {
        ...
        nf.setMinimumFractionDigits(v.scale() > 0 ? 2 : 0);
        return nf.format(v);
    }
